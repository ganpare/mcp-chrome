<template>
  <div class="model-cache-section">
    <h2 class="section-title">モデルキャッシュ管理</h2>

    <!-- Cache Statistics Grid -->
    <div class="stats-grid">
      <div class="stats-card">
        <div class="stats-header">
          <p class="stats-label">キャッシュサイズ</p>
      ...
      <div class="stats-card">
        <div class="stats-header">
          <p class="stats-label">キャッシュ項目数</p>
    ...
    <div v-if="cacheStats && cacheStats.entries.length > 0" class="cache-details">
      <h3 class="cache-details-title">キャッシュ詳細</h3>
        ...
        <div v-for="entry in cacheStats.entries" :key="entry.url" class="cache-entry">
          <div class="entry-info">
            ...
            <div class="entry-details">
              ...
              <span v-if="entry.expired" class="entry-expired">期限切れ</span>
            </div>
          </div>
        </div>
      </div>
